...
export const Translations = {
  ...
  'en-GB': [
    { id: 'sezzle-header', text: 'Sezzle it.' },
    { id: 'desktop-header', text: 'The way forward.' },
    { id: 'mobile-header', text: 'The way forward.' },
    { id: 'desktop-main-1', text: 'Pay with Sezzle and split your order into ' },
    { id: 'desktop-main-2', text: '4 smaller payments.' },
    { id: 'mobile-main', text: 'Pay with Sezzle and split your order into 4 smaller payments' },
    { id: 'pie-1', text: 'today' },
    { id: 'pie-2', text: '30 days' },
    { id: 'pie-3', text: '60 days' },
    { id: 'pie-4', text: '90 days' },
    { id: 'single-feature-1', text: '' },
    { id: 'single-feature-2', text: '' },
    { id: 'single-feature-3', text: '' },
    { id: 'single-feature-4', text: '' },
    { id: 'single-feature-5', text: '' },
    { id: 'single-feature-6', text: '' },
    { id: 'desktop-footer-1', text: 'Simply choose' },
    { id: 'desktop-footer-2', text: 'Sezzle' },
    { id: 'desktop-footer-3', text: 'at checkout!' },
    { id: 'mobile-footer-1', text: 'Simply choose Sezzle' },
    { id: 'mobile-footer-2', text: 'at checkout!' },
    { id: 'terms', text: 'Easy. Modern. Innovative.' },
  ],
  'fr-FR': [
    { id: 'sezzle-header', text: 'Sezzle it.' },
    { id: 'desktop-header', text: 'La voie à suivre.' },
    { id: 'mobile-header', text: 'La voie à suivre.' },
    { id: 'desktop-main-1', text: 'Payez avec Sezzle et divisez votre commande en ' },
    { id: 'desktop-main-2', text: '4 petits paiements.' },
    { id: 'mobile-main', text: 'Payez avec Sezzle et divisez votre commande en 4 petits paiements.' },
    { id: 'pie-1', text: 'aujourd\'hui' },
    { id: 'pie-2', text: '30 jours' },
    { id: 'pie-3', text: '60 jours' },
    { id: 'pie-4', text: '90 jours' },
    { id: 'single-feature-1', text: '' },
    { id: 'single-feature-2', text: '' },
    { id: 'single-feature-3', text: '' },
    { id: 'single-feature-4', text: '' },
    ...
    { id: 'mobile-footer-1', text: 'Vous n\'avez qu\'à choisir Sezzle' },
    { id: 'mobile-footer-2', text: 'au moment de régler!' },
    { id: 'terms', text: 'Facile. Moderne. Innovant.' },
  ],
  'de-DE': [
    { id: 'sezzle-header', text: 'Sezzle it.' },
    { id: 'desktop-header', text: 'Sei der Zukunft voraus!' },
    { id: 'mobile-header', text: 'Sei der Zukunft voraus!' },
    { id: 'desktop-main-1', text: 'Zahle mit Sezzle und teile deinen Gesamtbestellwert' },
    { id: 'desktop-main-2', text: 'in 4 günstigere Teilbeträge auf.' },
    { id: 'mobile-main', text: 'Zahle mit Sezzle und teile deinen Gesamtbestellwert in 4 günstigere Teilbeträge auf.' },
    { id: 'pie-1', text: 'heute' },
    { id: 'pie-2', text: '30 Tage' },
    { id: 'pie-3', text: '60 Tage' },
    { id: 'pie-4', text: '90 Tage' },
    ...
    { id: 'single-feature-5', text: '' },
    { id: 'single-feature-6', text: '' },
    { id: 'desktop-footer-1', text: 'Einfach' },
    { id: 'desktop-footer-2', text: 'Sezzle' },
    { id: 'desktop-footer-3', text: 'beim Zahlvorgang wählen!' },
    { id: 'mobile-footer-1', text: 'Einfach Sezzle' },
    { id: 'mobile-footer-2', text: 'beim Zahlvorgang wählen!' },
    { id: 'terms', text: 'Innovativ. Einfach. Modern.' },
  ],
};
